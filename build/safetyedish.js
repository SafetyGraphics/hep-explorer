...
function calculateRatios(d, participant_obj) {
    ...
    participant_obj.rRatio = participant_obj[this.config.measure_details.find(function (measure_detail) {
        return measure_detail.axis === 'x';
    }).label + '_relative_uln/' + this.config.measure_details.find(function (measure_detail) {
...
function setDomain(dimension) {
    ...
    if (this.config[dimension].type == 'linear') {
        ...
        var measure = config.measure_details.find(function (f) {
            ...
            values = this.imputed_data.filter(function (f) {
